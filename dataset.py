...
class ZDataset(Dataset):
    ...
    def __init__(self, dataset_path, augmentations):
        ...
        if self.augmentations:
            self.transforms = v2.Compose([
                v2.CenterCrop(self.opt.patch_size) if self.opt.resize_par == 'crop' else v2.Resize((self.opt.patch_size, self.opt.patch_size), interpolation=InterpolationMode.BICUBIC),
    ...
    def __getitem__(self, idx):
        ...
        # Apply normalization
        f1, gt, f2 = normalization(f1, gt, f2, self.opt)
